...
var postcssSass = _interopDefault(require('postcss-sass'));
var postcssScss = _interopDefault(require('postcss-scss'));
var postcssSmartAsset = _interopDefault(require('postcss-smart-asset'));
var postcssSugarSS = _interopDefault(require('sugarss'));
...
function rebase(options) {
  ...
  var _options = options,
      ...
      filter = rollupPluginutils.createFilter(include, exclude),
      wrappers = {},
      assets = {},
      files = {};
  return {
    ...
    resolveId: function resolveId(importee, importer) {
      return new Promise(function ($return, $error) {
        ...
        return Promise.resolve(assetHash.getHash(fileSource)).then(function ($await_7) {
          try {
            fileHash = $await_7;
